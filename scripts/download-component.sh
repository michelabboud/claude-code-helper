...
if [[ "$BUILD_REQUIRED" == "true" ]]; then
  ...
  echo ""
  echo "To update this MCP server:"
  echo "  1. cd /path/to/claude-code-helper"
  echo "  2. git pull"
  echo "  3. ./scripts/update-component.sh ${COMPONENT_KEY}"
  echo ""
  echo "Or build manually:"
  echo "  cd mcp-servers/$(basename "$COMPONENT_KEY")"
