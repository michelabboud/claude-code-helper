...
# Or manually
cp -r examples/plugins/modern-web-stack ~/.claude/plugins/
```
...
```bash
cp examples/agents/subagents/react-nextjs-expert.md ~/.claude/agents/
cp examples/agents/subagents/nodejs-typescript-expert.md ~/.claude/agents/
cp examples/agents/subagents/database-expert.md ~/.claude/agents/
```

2. **Install Skills**:
```bash
cp -r examples/skills/api-design-patterns ~/.claude/skills/
cp -r examples/skills/tdd-workflow ~/.claude/skills/
cp -r examples/skills/code-review-workflow ~/.claude/skills/
cp -r examples/skills/refactoring-strategy ~/.claude/skills/
cp -r examples/skills/database-design-patterns ~/.claude/skills/
```

3. **Install Commands**:
```bash
cp examples/commands/scaffold.md ~/.claude/commands/
cp examples/commands/test-generate.md ~/.claude/commands/
cp examples/commands/api-docs.md ~/.claude/commands/
```

4. **Install Hooks**:
```bash
cp examples/hooks/security-scan.md ~/.claude/hooks/
cp examples/hooks/code-quality-gate.md ~/.claude/hooks/
cp examples/hooks/build-validation.md ~/.claude/hooks/
```
