...
- **Redis Expert**: `examples/sub-agents/redis-expert.md`
- **Database Patterns**: `examples/skills/database-design-patterns.md`
- **Performance Optimization**: `examples/skills/performance-optimization.md`
