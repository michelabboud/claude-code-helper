...
- **Terraform for GCP**: `examples/skills/terraform-gcp.md`
- **BigQuery Optimization**: `examples/skills/bigquery-optimization.md`
- **Data Engineering**: `examples/sub-agents/data-engineering-expert.md`
