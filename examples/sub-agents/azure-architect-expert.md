...
- **Terraform for Azure**: `examples/skills/terraform-azure.md`
- **Kubernetes Patterns**: `examples/skills/kubernetes-patterns.md`
- **Azure DevOps**: `examples/skills/azure-devops.md`
