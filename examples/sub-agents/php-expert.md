...
- **Laravel Development**: `examples/sub-agents/laravel-expert.md`
- **WordPress Development**: `examples/sub-agents/wordpress-expert.md`
- **API Development**: `examples/skills/api-design.md`
