...
- **PHP Best Practices**: `examples/skills/php-best-practices.md`
- **API Development**: `examples/skills/api-design.md`
- **Testing**: `examples/skills/testing-best-practices.md`
- **Database**: `examples/skills/database-design-patterns.md`
