...
- **Unity Best Practices**: `examples/skills/unity-optimization.md`
- **Game AI Patterns**: `examples/skills/game-ai-patterns.md`
- **Multiplayer Networking**: `examples/skills/game-networking.md`
