...
- **TypeScript Guide**: `examples/skills/typescript-advanced.md`
- **RxJS Patterns**: `examples/skills/rxjs-patterns.md`
- **Testing Guide**: `examples/skills/testing-best-practices.md`
- **Frontend Design System**: `examples/skills/design-system.md`
