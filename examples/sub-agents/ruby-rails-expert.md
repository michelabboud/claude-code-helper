...
- **Ruby Style Guide**: `examples/skills/ruby-best-practices.md`
- **API Development**: `examples/skills/api-design.md`
- **Testing Patterns**: `examples/skills/testing-best-practices.md`
- **Database Optimization**: `examples/skills/database-design-patterns.md`
