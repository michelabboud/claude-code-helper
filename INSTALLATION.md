...
# Commands
cp -r examples/commands/* ~/.claude/commands/
```
...
1. **Create your own agent:**
   ```bash
   cp examples/agents/mcp-agents/security-reviewer.json ~/.claude/agents/my-agent.json
