...
- `guides/subagents-guide/examples/` vs `examples/agents/subagents/` - ⚠️ POTENTIAL OVERLAP
...
**Status**: This is INTENTIONAL per `examples/sub-agents/README.md`:
...
#### Skills
- `examples/skills/` - ⚠️ No install instructions in individual files
...
- Add install section to each skill file (examples/skills/*.md)
