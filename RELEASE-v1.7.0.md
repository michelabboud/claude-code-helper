...
**Created: `examples/agents/rag-coder.md`**
...
**Location:** `examples/agents/rag-coder.md`
...
- **[rag-coder Agent](./examples/agents/rag-coder.md)** - Complete agent guide
