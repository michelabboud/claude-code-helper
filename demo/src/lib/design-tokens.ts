 ...
 * Should trigger: design-system-guardian, css-tailwind-expert
 */
...
// Spacing Scale (in pixels, maps to Tailwind)
...
export type TaskPriority = keyof typeof taskPriorityColors;
export type ProjectStatus = keyof typeof projectStatusColors;
